...
class BulkPanel(BasePanel):
    ...
    def __init__(self, frame: wx.Frame, parent: wx.Notebook, tab_idx: int):
        ...
        # 一括サイジング確認ボタン
        self.check_btn_ctrl = wx.Button(self, wx.ID_ANY, u"批量处理尺寸确认", wx.DefaultPosition, wx.Size(200, 50), 0)
        ...
        # 一括サイジング実行ボタン
        self.bulk_btn_ctrl = wx.Button(self, wx.ID_ANY, u"批量执行", wx.DefaultPosition, wx.Size(200, 50), 0)
