...
class HistoryFilePickerCtrl(BaseFilePickerCtrl):
    ...
    def __init__(self, frame, parent, title, message, wildcard, style, tooltip, \
        ...
        self.histroy_btn_ctrl = wx.Button(parent, wx.ID_ANY, u"历史", wx.DefaultPosition, wx.DefaultSize, 0)
        self.histroy_btn_ctrl.SetToolTip(u"到目前为止指定的{0}可以重新指定。".format(title))
    ...
    def on_show_history(self, event):
        ...
        with wx.SingleChoiceDialog(self.parent, "请选择文件，双击或单击OK按钮。", caption="历史文件选择",
